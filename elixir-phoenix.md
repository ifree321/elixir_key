...
## 前端
1. [phoenix 使用Webpack](https://medium.com/@kimlindholm/adding-webpack-3-to-phoenix-e6633dbc2bc4)
2. [phoenix 使用Webpack 3.x](https://blog.danivovich.com/2017/08/30/webpack-phoenix/)
...
## Phoenix 语言国际化
1. [A better way to set and manage Locale Date in your phoenix applications](https://phraseapp.com/blog/posts/set-and-manage-locale-data-in-your-phoenix-l10n-project/?utm_source=social_media&utm_medium=phoenix_content)
2. [Translating Phoenix applications with phoenix](https://phraseapp.com/blog/posts/i18n-for-phoenix-applications-with-gettext)

## 存储
1. [Ecto](https://medium.com/@yijuwu/elixir-phoenix-v1-3-1weeks-開發心得-2-2fc8e19f9f34)
2. [浏览器缓存机制](http://www.cnblogs.com/skynet/archive/2012/11/28/2792503.html)
3. [浏览器强缓存和协商缓存](https://www.cnblogs.com/lyzg/p/5125934.html)
4. [浏览器缓存方案](https://juejin.im/entry/5978576b518825630627bb47)
5. [浏览器缓存切换语言选项](http://www.cnblogs.com/seasons1987/archive/2012/10/09/2716345.html)
6. [数据库索引策略](http://www.nyankosama.com/2014/12/19/high-performance-index)
7. [Mnesia](https://www.ttalk.im/topics/52)
...
## 功能实现
1. [one time password、totp](https://github.com/riverrun/one_time_pass_ecto/blob/master/lib/one_time_pass_ecto/baseddd.ex)
2. [验证码](https://www.jianshu.com/p/c63b78a373ad)
3. [数字输入校验及backspace](http://blog.csdn.net/qq_36242361/article/details/75245067)
4. [send mail](https://elixircasts.io/sending-email-with-bamboo-part-1)

## 技巧
1. [10个elixir杀手级小技巧](https://www.jianshu.com/p/2f850ceb2784)
